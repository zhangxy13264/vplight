...
class PressLightAgent(RLAgent):
    ...
    def reset(self):
        ...
        self.delay = LaneVehicleGenerator(self.world, inter_obj,
                                                     ...
                                                     negative=False)
        self.pedestrian_queue = SidewalkPedestrianGenerator(self.world, self.inter_obj,
                                                     ["sidewalk_waiting_count"], in_only=True,
                                                     negative=False)
        self.pedestrian_delay = SidewalkPedestrianGenerator(self.world, self.inter_obj,
                                                     ["sidewalk_delay"], in_only=True, average=None,
                                                     negative=False)
